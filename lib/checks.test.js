...
describe("should checks stats", () => {
    ...
    test("should return grade F if no url provided", () => __awaiter(void 0, void 0, void 0, function* () {
        const expectedJson = { "grade": "F", "url": "", "uri": "" };
        const result = yield (0, checks_1.checks)(null, { exactExpectedRegex, minExpectedRegex: undefined });
