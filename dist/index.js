...
const parseUrl_1 = __nccwpck_require__(654);
/**
...
const checks_1 = __nccwpck_require__(321);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const results = yield (0, checks_1.checks)(url, { exactExpectedRegex, minExpectedRegex });
